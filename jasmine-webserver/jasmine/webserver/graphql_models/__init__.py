...
from jasmine.webserver.graphql_models.project_models import project_models_type_defs
...
graphql_schema = make_executable_schema(type_defs, [query_obj, mutation_obj])
