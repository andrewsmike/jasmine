...
--
-- Host: 127.0.0.1    Database: jasmine_test
-- ------------------------------------------------------
...
--
-- Current Database: `jasmine_test`
--

DROP DATABASE IF EXISTS jasmine_test;
CREATE DATABASE  /*!32312 IF NOT EXISTS*/ `jasmine_test` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
INSERT INTO `backends` VALUES (1,'jasmine-web','mysql','{\"connection_args\": {\"host\": \"127.0.0.1\", \"port\": 3305, \"user\": \"jasmine_web_su\", \"database\": \"jasmine_test\", \"password\": \"password\"}}',1);
...
INSERT INTO `materializations` VALUES (1,'view','active','{}',1,'{\"claimed_resources\": {\"views\": [[\"jasmine_test\", \"analytics/user_project_facts_view\"]], \"tables\": [], \"triggers\": []}}'),(7,'view','terminated','{}',2,'{\"claimed_resources\": {}}'),(9,'view','active','{}',28,'{\"claimed_resources\": {\"views\": [[\"jasmine_test\", \"analytics/user_view_facts_view\"]], \"tables\": [], \"triggers\": []}}'),(10,'view','active','{}',43,'{\"claimed_resources\": {\"views\": [[\"jasmine_test\", \"analytics/user_project_facts_from_view_view\"]], \"tables\": [], \"triggers\": []}}'),(16,'view','active','{\"keys\": {\"path\": [\"path\"], \"title\": [\"title\"], \"title2\": [\"title\", \"description\"], \"event_id\": [\"event_id\"], \"description\": [\"description\"]}, \"unique_keys\": {\"event_id\": [\"event_id\"]}, \"start_timestamp\": 1636499182, \"column_type_decls\": {\"path\": \"VARCHAR(256)\", \"state\": \"VARCHAR(64)\", \"title\": \"VARCHAR(255)\", \"config\": \"TEXT\", \"method\": \"VARCHAR(64)\", \"context\": \"TEXT\", \"event_id\": \"BIGINT NOT NULL\", \"updated_ts\": \"DATETIME\", \"description\": \"VARCHAR(255)\"}, \"updated_ts_column_name\": \"updated_ts\"}',51,'{\"claimed_resources\": {\"views\": [[\"jasmine_test\", \"incremental_demo_view\"]], \"tables\": [], \"triggers\": []}}'),(17,'view','active','{}',52,'{\"claimed_resources\": {\"views\": [[\"jasmine_test\", \"incremental_demo_from_upsert_view\"]], \"tables\": [], \"triggers\": []}}'),(18,'upsert','active','{\"keys\": {\"path\": [\"path\"], \"title\": [\"title\"], \"title2\": [\"title\", \"description\"], \"event_id\": [\"event_id\"], \"description\": [\"description\"]}, \"unique_keys\": {\"event_id\": [\"event_id\"]}, \"start_timestamp\": 1636499182, \"column_type_decls\": {\"path\": \"VARCHAR(256)\", \"state\": \"VARCHAR(64)\", \"title\": \"VARCHAR(255)\", \"config\": \"TEXT\", \"method\": \"VARCHAR(64)\", \"context\": \"TEXT\", \"event_id\": \"BIGINT NOT NULL\", \"updated_ts\": \"DATETIME\", \"description\": \"VARCHAR(255)\"}, \"updated_ts_column_name\": \"updated_ts\"}',51,'{\"table_spec\": {\"indices\": {\"_jsmn_key_0\": [\"description\"], \"_jsmn_key_1\": [\"event_id\"], \"_jsmn_key_2\": [\"path\"], \"_jsmn_key_3\": [\"title\", \"description\"]}, \"primary_key\": [\"jsmn_auto_id\"], \"column_names\": [\"jsmn_auto_id\", \"event_id\", \"path\", \"method\", \"state\", \"config\", \"context\", \"title\", \"description\", \"updated_ts\"], \"foreign_keys\": [], \"unique_indices\": {\"event_id\": [\"event_id\"]}, \"column_type_decls\": {\"path\": \"VARCHAR(256)\", \"state\": \"VARCHAR(64)\", \"title\": \"VARCHAR(255)\", \"config\": \"TEXT\", \"method\": \"VARCHAR(64)\", \"context\": \"TEXT\", \"event_id\": \"BIGINT NOT NULL\", \"updated_ts\": \"DATETIME\", \"description\": \"VARCHAR(255)\", \"jsmn_auto_id\": \"BIGINT NOT NULL AUTO_INCREMENT\"}}, \"high_water_mark\": 1641688821.382447, \"claimed_resources\": {\"views\": [], \"tables\": [[\"jasmine_test\", \"incremental_demo_upsert\"]], \"triggers\": []}}');
